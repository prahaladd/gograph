...
func (suite *Neo4JIntegrationTestSuite) SetupTest() {
	protocol := getFromEnvWithDefault("NEO4J_PROTOCOL", defaultProtocol)
	host := getFromEnvWithDefault("NEO4J_HOST", defaultHost)
	portString := getFromEnvWithDefault("NEO4J_PORT", "")
	...
	realm := getFromEnvWithDefault("NEO4J_REALM", defaultRealm)
	user := getFromEnvWithDefault("NEO4J_USER", defaultUsername)
	pwd := getFromEnvWithDefault("NEO4J_PWD", defaultPassword)
